...
//                        creator requests
                                ...
                                .requestMatchers(HttpMethod.PATCH, "/api/v1/creator-requests/rejection").hasRole("ADMIN")
                                .requestMatchers(HttpMethod.GET, "/api/v1/creator-requests/me").hasAnyRole("CREATOR", "SUBSCRIBER")
...
//                        problems
                                ...
                                .requestMatchers(HttpMethod.GET, "/api/v1/problems/user-progress").hasAnyRole("CREATOR", "SUBSCRIBER")
