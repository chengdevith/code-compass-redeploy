    ...
    public SecurityFilterChain apiSecurity(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests( request ->
                request
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/code-compass/problems/unverified").hasAnyRole("ADMIN", "CREATOR")
                        ...
                        .requestMatchers("/api/v1/code-compass/problems/all").hasRole("ADMIN")
                        .requestMatchers("/api/v1/code-compass/problems/unverified").hasRole("ADMIN")
                        ...
                        .requestMatchers("/api/v1/code-compass/badges/unverified").hasAnyRole("ADMIN", "CREATOR")
